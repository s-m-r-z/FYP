...
class metaladdetails extends StatefulWidget {
  late String avgweight,
      ...
      noofarticles,
      price;
  metaladdetails(String avgweight, String contactno, String description,
  ...
  @override
  _metaladdetailsState createState() => _metaladdetailsState(avgweight,
      contactno, description, imageURL, material, noofarticles, price);
}

class _metaladdetailsState extends State<metaladdetails> {
  late String avgweight,
      contactno,
      description,
      imageURL,
      ...
      noofarticles,
      price;
  _metaladdetailsState(String avgweight, String contactno, String description,
      String imageURL, String material, String noofarticles, String price) {
    this.avgweight = avgweight;
    this.contactno = contactno;
    this.description = description;
