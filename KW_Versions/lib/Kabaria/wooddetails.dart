...
class woodaddetails extends StatefulWidget {
  late String avgweight,
      ...
      noofarticles,
      price;
  woodaddetails(String avgweight, String contactno, String description,
  ...
  @override
  _woodaddetailsState createState() => _woodaddetailsState(avgweight, contactno,
      description, imageURL, material, noofarticles, price);
}

class _woodaddetailsState extends State<woodaddetails> {
  late String avgweight,
      contactno,
      description,
      imageURL,
      ...
      noofarticles,
      price;
  _woodaddetailsState(String avgweight, String contactno, String description,
      String imageURL, String material, String noofarticles, String price) {
    this.avgweight = avgweight;
    this.contactno = contactno;
    this.description = description;
