...
import 'metaldetails.dart';

class metalretrievedata extends StatefulWidget {
  metalretrievedata();
  _metalretrievedataState createState() => _metalretrievedataState();
}

class _metalretrievedataState extends State<metalretrievedata> {
  _metalretrievedataState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('metals').snapshots(),
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => metaladdetails(
                                document['avgweight'],
                                document['contactno'],
