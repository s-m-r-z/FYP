...
//import 'package:kachrewala_chat_portal/Kachra/Metalretrivedata.dart';
import 'paperretrievedata.dart';
//import 'package:kachrewala_chat_portal/Kachra/plasticretrivedata.dart';
import 'package:page_transition/page_transition.dart';
import 'google_maps.dart';
import 'package:url_launcher/url_launcher.dart';

class paperaddetails extends StatefulWidget {
  late String avgweight,
      ...
      noofarticles,
      price;
  paperaddetails(String avgweight, String contactno, String description,
  ...
  @override
  _paperaddetailsState createState() => _paperaddetailsState(avgweight,
      contactno, description, imageURL, material, noofarticles, price);
}

class _paperaddetailsState extends State<paperaddetails> {
  late String avgweight,
      contactno,
      description,
      imageURL,
      ...
      noofarticles,
      price;
  _paperaddetailsState(String avgweight, String contactno, String description,
      String imageURL, String material, String noofarticles, String price) {
    this.avgweight = avgweight;
    this.contactno = contactno;
    this.description = description;
